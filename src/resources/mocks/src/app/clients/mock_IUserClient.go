...
func (_m *MockIUserClient) GetUsers() ([]model.UserResponse, error) {
	ret := _m.Called()
	...
	var r0 []model.UserResponse
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]model.UserResponse, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []model.UserResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.UserResponse)
...
func (_e *MockIUserClient_Expecter) GetUsers() *MockIUserClient_GetUsers_Call {
	return &MockIUserClient_GetUsers_Call{Call: _e.mock.On("GetUsers")}
}

func (_c *MockIUserClient_GetUsers_Call) Run(run func()) *MockIUserClient_GetUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockIUserClient_GetUsers_Call) Return(_a0 []model.UserResponse, _a1 error) *MockIUserClient_GetUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIUserClient_GetUsers_Call) RunAndReturn(run func() ([]model.UserResponse, error)) *MockIUserClient_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
